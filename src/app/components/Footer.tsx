...
export default function Footer() {
  return (
    <footer className="bg-[var(--green)] text-white text-base mt-12 border-t border-gray-100">
      <div className="max-w-[1400px] mx-auto pt-22 pb-4 px-6">
        <div className="grid lg:grid-cols-5 justify-between gap-8">
          {/* Logo */}
          ...
          <div className="col-span-2 grid grid-cols-1  md:grid-cols-2 gap-8 flex-1">
             <div>
              <h2 className="text-2xl font-medium mb-3 flex items-center gap-2">
                Quick Links <span className="h-1 w-8 bg-white block ml-3 rounded opacity-50"></span>
              </h2>
            ...
            <div>
              <h2 className="text-2xl font-medium mb-3 flex items-center gap-2">
                Services <span className="h-1 w-8 bg-white block ml-3 rounded opacity-50"></span>
              </h2>
              <ul className="space-y-1">
                <li>Machine Tools</li>
          ...
          <div className="col-span-1 flex flex-row justify-end gap-3">
            <a href="https://linkedin.com" aria-label="Linkedin" target="_blank" rel="noopener noreferrer">
              <Linkedin size={32} strokeWidth={1} className="text-white  transition" />
            </a>
            <a href="https://x.com" aria-label="X" target="_blank" rel="noopener noreferrer">
              <Twitter size={28} strokeWidth={1} className="text-white  transition" />
            </a>
            <a href="https://x.com" aria-label="X" target="_blank" rel="noopener noreferrer">
              <Instagram size={28} strokeWidth={1} className="text-white  transition" />
            </a>
            <a href="https://x.com" aria-label="X" target="_blank" rel="noopener noreferrer">
              <Facebook size={28} strokeWidth={1} className="text-white  transition" />
            </a>
            <a href="https://x.com" aria-label="X" target="_blank" rel="noopener noreferrer">
              <Youtube size={28} strokeWidth={1} className="text-white  transition" />
            </a>
          </div>
        </div>
        {/* Bottom Links */}
