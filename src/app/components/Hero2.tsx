...
const Hero2 = ({
    ...
    // Breadcrumb alignment class based on prop
        ...
        <>
            {isArabic ? (
                <section className="mt-[70px] lg:mt-[90px] w-full bg-[var(--green)] text-white flex flex-col justify-center items-center text-center relative">
                    <div className="bg-fixed absolute inset-0 bg-[url('/about.png')] bg-cover bg-[40%_center] lg:bg-[30%_center]"></div>
                    ...
                    >
                        <h2 className="text-3xl lg:text-4xl font-medium">{heading}</h2>

                        {(breadcrumbText ?? heading) && (
                            <div
                                className={`flex items-center gap-2 breadcrumb mt-3 mb-2 ${breadcrumbAlignClass
                                    }`}
                            >
                                <Link
                                    href="/"
                                    className="text-md md:text-lg my-1 text-white hover:text-[var(--green1)]"
                                >
                                    الرئيسية
                                </Link>
                                ...
                                <span className="text-md md:text-lg my-1 font-medium text-[var(--green1)]">
                                    {breadcrumbText ?? heading}
                                </span>
                            </div>
                        )}
